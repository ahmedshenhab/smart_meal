...
class AppColor {
  ...
  static const Color scaffolddark = Color(0xFF60534D);
  ...
  static const Color primary = Color(0xFFFA5A19);

  static const Color warmOrange = Color(0xFFFB6B32);
  ...
  static const Color grayTone = Color(0xFFBDADAD);
  ...
  static const Color steelBlueGray = Color(0xFF97A2B0);

  static const Color skyBlue = Color(0xFFCCE7F5);

  static const Color softLavenderGray = Color(0xFFC4C7DC);
}
