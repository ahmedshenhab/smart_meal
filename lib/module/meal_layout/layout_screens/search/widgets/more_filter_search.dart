...
class MoreFilterSearch extends StatelessWidget {
  const MoreFilterSearch({super.key});
      ...
      child: InkWell(
        ...
        onTap: () {
          SideSheet.right(
            ...
            sheetBorderRadius: 30.r,
            body: FiltersModal(cubit: SearchByMealCubit.get(context)),
            context: context,
